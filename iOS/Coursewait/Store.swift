...
final class Store: ObservableObject {
    ...
    private let fileName = "coursewait_entries.json"
    ...
    static func seedData() -> [Entry] {
        let now = Date()
        return [
            Entry(title: "Sample Waitlisted Course One", detail: "First example entry.", date: now),
            Entry(title: "Sample Waitlisted Course Two", detail: "Second example entry.", date: now.addingTimeInterval(-86400)),
            Entry(title: "Sample Waitlisted Course Three", detail: "Third example entry.", date: now.addingTimeInterval(-172800)),
        ]
    }
}
